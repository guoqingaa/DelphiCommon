...
type
  ...
  public
    ...
    function Execute(aSelectedList: TList = nil) : Boolean;
...
function TFilterDialog.Execute(aSelectedList: TList): Boolean;
var
  i, iP : Integer;
begin
  //
  ...
  begin
    ...
    begin
      iP := ListSelecteds.Items.IndexOfObject(TObject(aSelectedList.Items[i]));
      if iP >= 0 then
        ListSelecteds.Selected[iP] := True;
    end;
  end;
  //
