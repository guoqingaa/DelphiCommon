...
const
  ...
  FILE_BACKUP_DB_ACCESS = 'db_backup_access.txt';
...
{$ENDIF}
  ...
  protected
    ...
    function NewBackupConnection: TCustomConnection; virtual; abstract;
  public
    ...
    property BackupAccessFileName : String read FBackupAccessFileName write FBackupAccessFileName;
...
{$IFNDEF VER150}
  ...
  protected
    function NewConnection: TCustomConnection; override;
    function NewBackupConnection: TCustomConnection; override;
...
begin
  ...
  (Result.Query as TFDQuery).FetchOptions.RecsSkip
...
function TFDConnector.NewBackupConnection: TCustomConnection;
begin
  ...
  begin
    ...
    //
    if FileExists(FBackupAccessFileName) then
      Params.LoadFromFile(FBackupAccessFileName)
    else if FileExists(FILE_BACKUP_DB_ACCESS) then
      Params.LoadFromFile(FILE_BACKUP_DB_ACCESS);
    //
